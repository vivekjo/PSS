...
<html>
    <head>
        ...
        <title>:: NewArrival Entry :: Payment Scheduling :: Sri Lakshmi Jewellery</title>
		...
		<script src="../js/transactions/newarrival.js"></script>
		...
		<script type="text/javascript">
			...
			function clear(){
				...
				var tableObj = document.getElementById("newarrivaltable");
											...
											<table id="supplier-table">
												<tr height="25px">
													...
													<td>
														...
														<img src="../images/go.png" onclick="getNewArrival();" />
													</td>
												</tr>
												<tr height="25px">
													<td width="120px">
												...
												<tr>
													<td colspan="2">
														<table id="newarrivaltable" class="newarrival-table" cellpadding="3px" FRAME="box" RULES="all">
												...
												<tr height="60px">
													...
													<td>
														<div id="add-button-div">
															<a href="#" class="uibutton1" onclick="addNewArrival();">
														...
														<div id="edit-button-div" style="display:none">
															<a href="#" class="uibutton1" onclick="deleteNewarrival();">
