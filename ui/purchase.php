...
<html>
    <head>
        ...
        <title>:: Purchase Entry :: Payment Scheduling :: Sri Lakshmi Jewellery</title>
											...
											<table id="supplier-table">
												...
												<tr height="25px">
													...
													<td>
														...
														<img src="../images/go.png" onclick="getPurchase()" />
													</td>
												</tr>
												<tr>
													<td colspan="2">
												...
												<tr height="60px">
													...
													<td>
														<div id="add-button-div">
															<a href="#" class="uibutton1" onclick="addPurchase();">
														...
														<div id="edit-button-div" style="display:none">
															<a href="#" class="uibutton1" onclick="updatePurchase();">
																<span class="uitext1">Update</span>
															</a>
															<a href="#" class="uibutton1" onclick="deletePurchase();">
