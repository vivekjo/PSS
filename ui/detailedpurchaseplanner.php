...
<html>
    ...
    <body>
    	...
    	<div id="reportdetailsdiv">
    		DETAILED PURCHASE PLANNER FROM <?php echo $xmlBuilder->getFormattedDateString($reportDetails['fromdate'],'d/m/Y')?> TO <?php echo $xmlBuilder->getFormattedDateString($reportDetails['todate'],'d/m/Y')?>
    	</div>
		<div id="psreportdiv">
			<?php 
				$incomingHeads = null;	
			...
			?>
				<table id="purchaseplannertable" style="font-size:11px;" class="purchase-table" cellpadding="3px">
						<tr height="35px" class="highlighted-row">
						...
						?>
								<tr height="25px" class="details-head1">
									<td>
										<?php echo $head; ?>
									</td>
									<?php 
