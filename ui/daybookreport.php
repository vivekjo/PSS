...
<html>
    <head>
        ...
        <title>:: Daybook Report :: Payment Scheduling :: Sri Lakshmi Jewellery</title>
							...
							<div style="float:right;margin-top:-4px">
								<table cellspacing="3" cellpadding="2">
									<tr valign="middle">
										...
										<td valign="top">
											<img src="../images/go.png" onclick="getDaybookBySelectedDate()" />
											<img src="../images/printer.jpg" onclick="printDaybook()" />
										</td>
										<td width="10"></td>
										<td>
											<img src="../images/arrow-left.png" onclick="getPrevDateDaybook()" /> 
											<img src="../images/home.png" onclick="getTodaysDaybook()" />
											<img src="../images/arrow-right.png" onclick="getNextDateDaybook()" />
										</td>
									</tr>
								</table>
							</div>
