...
<html>
    <head>
        ...
        <title>:: Projection Entry :: Payment Scheduling :: Sri Lakshmi Jewellery</title>
		...
		<script src="../js/transactions/projection.js"></script>
		...
		<script type="text/javascript">
			...
			function loadData(){
				...
				getClosing();
				getSuspense();
				setTimeout('getTodaysProjection()',200);
			}
		</script>
												...
												<tr height="60px">
													...
													<td>
														<div id="add-button-div">
															<a href="#" class="uibutton1" onclick="addProjection(); ">
														...
														<div id="edit-button-div" style="display:none">
															<a href="#" class="uibutton1" onclick="modifyProjection()">
																<span class="uitext1">Save</span>
															</a>
															<a href="#" class="uibutton1" onclick="deleteProjection();">
								...
								<div class="panel-header-element2" style="padding-top:0px;padding-bottom:1px;height:25px;">
	    							<table cellspacing="3" cellpadding="2">
										<tr valign="middle">
											...
											<td valign="top"><input type="image" title="left" src="../images/go.png" onclick="getProjectionBySelectedDate()"></td>
											<td width="120"></td>
											<td>
												<input type="image" title="left" src="../images/arrow-left.png" onclick="getPrevDateProjection()"> 
												<input type="image" title="today" src="../images/home.png" onclick="getTodaysProjection()">
												<input type="image" title="right" src="../images/arrow-right.png" onclick="getNextDateProjection()">
											</td>
										</tr>
									</table>
	    						</div>
